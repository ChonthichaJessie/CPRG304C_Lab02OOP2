...
public class Driver
{
	...
	public static void main( String[] args )
	{
		...
		System.out.println( "Default students list");
		
		for (Student s : studs) {
			System.out.println( s.toString() );
		}
		
		System.out.println( "\nSorted students list by age");
		...
		System.out.println( "\nSorted students list by age, then name");
		Collections.sort(studs, new CompareByAgeThenName());
		for (Student n : studs)
		{
			System.out.println( n.toString());
		}
